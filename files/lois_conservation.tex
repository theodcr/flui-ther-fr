...
\begin{itemize}
    ...
    \item $\vec{f}$ représente les efforts qui agissent \textit{en volume} (en N/m\up{3}), les principaux efforts concernés sont la gravité terrestre ($\vec{g}$) et la gravitation universelle
\end{itemize}
